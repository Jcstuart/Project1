    			...
    			<div class="span10 offset1">
	    			...
	    			<form class="form-horizontal" action="event_update.php?id=<?php echo $id?>" method="post">
					  ...
					  <div class="control-group <?php echo !empty($locationError)?'error':'';?>">
					    ...
					    <div class="controls">
					      	<input name="mobile" type="location"  placeholder="Location" value="<?php echo !empty($location)?$location:'';?>">
					  ...
					  <div class="control-group <?php echo !empty($descriptionError)?'error':'';?>">
					    ...
					    <div class="controls">
					      	<input name="mobile" type="description"  placeholder="Description" value="<?php echo !empty($description)?$description:'';?>">
